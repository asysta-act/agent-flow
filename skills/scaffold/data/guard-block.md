...
| Draft skips test-engineer --e2e because "no e2e framework configured" | Read `[e2e_test]` in `.agent-flow/config.toml`; if absent, write `e2e_test.status = "skipped"` -- DO NOT leave at "pending". |
